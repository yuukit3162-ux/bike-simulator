...
public class PoliceNPCMnager2 : MonoBehaviour
{
    ...
    //    my_Rigidbody.AddForce(transform.forward * Mathf.Clamp(control.accel, -speed * 0.5f, speed), ForceMode.Acceleration);
    //    my_Rigidbody.AddTorque(transform.up * Mathf.Clamp(control.turnAccel, -rotateSpeed, rotateSpeed), ForceMode.Acceleration);
    //}
}
